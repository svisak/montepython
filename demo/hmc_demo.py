...
from functools import partial # Needed for JAX in classes
...
class MultivariateGaussian(montepython.SimpleBayes):
    ...
    def __init__(self, mu, cov):
        ...
        self.lnposterior_AD = jax.value_and_grad(self.lnposterior)

    # The decorators are necessary since lnposterior, lnprior, and lnlikelihood
    # has an argument 'self', which should not be traced and may trigger recompilation.
...
filename = 'hmc.h5' # Optional. Defaults to a timestamp. I recommend using the default.
